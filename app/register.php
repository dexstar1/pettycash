...
if(isset($_POST["register"]))
{
 ...
 else
 {
  ...
  if(isset($result))
  {
   ...
   <p>Please Open this link to verify your email address - ".$base_url."email_verification.php?activation_code=".$user_activation_code."
   <p>Best Regards,<br />Pettycash</p>
   ";
